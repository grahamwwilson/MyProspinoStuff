...
cgww - change to local .tbl files for easier integration with Condor
c      Data (Flnm(I), I=1,Isetmax0)
c     > / './Pro2_subroutines/cteq6m', 
c     >   './Pro2_subroutines/cteq6d', 
c     >   './Pro2_subroutines/cteq6l', 
c     >   './Pro2_subroutines/cteq6l',
c     >   './Pro2_subroutines/ctq61.'/
