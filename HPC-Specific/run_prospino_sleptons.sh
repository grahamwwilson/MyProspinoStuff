...
#
#SBATCH --job-name=slep-array         # Job name
...
#SBATCH --output=slep-array_%A_%a.log  # Standard output and error log
#SBATCH --error=slep-array_%A_%a.err   # Standard output and error log
