#!/bin/bash
#
# Run an array of 8 jobs for one particular input SLHA file
# Each job is one of the 8 lightest electroweakino production channels
#
...
TBLFILE=cteq6l1.tbl
ARGSFILE=${GITDIR}/HPC-Specific/ewino_subset_commands.txt
