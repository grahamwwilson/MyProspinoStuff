...
#
#SBATCH --job-name=ALL-array          # Job name
...
#SBATCH --output=ALL-array_%A_%a.log  # Standard output and error log
#SBATCH --error=ALL-array_%A_%a.err   # Standard output and error log
